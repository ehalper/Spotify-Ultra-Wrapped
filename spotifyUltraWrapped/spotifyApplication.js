...
app.post("/results", (req, res) => {
    ...
    apiCall(url)
        ...
        .then(result => {     // Result of second call
            ...
            //console.log(mapping)
            //console.log(topOverallArtists, topAppearances)
            ...
            //fix g12
            g12 = new Set([...g12].filter(x => !g123.has(x))) //g12 - g123
            g12 = ([...g12].filter(x => !g124.has(x))) //g12 - g123
            ...
            //
            commonSongsTable += "</tr><tr><th>Wrapped Year(s)</th>"
...
//let url19 = curl -X "GET" "https://api.spotify.com/v1/playlists/37i9dQZF1EteouiNQdvBtB/tracks?market=US&limit=100&offset=0" -H "Accept: application/json" -H "Content-Type: application/json" -H "Authorization: Bearer BQAob_M40L4fCqhJAFnZOwezTsTZyyGsSZlVpHUelq-aPUEbb9pATW78vDDTFBYfqLjuYyv2HbU_eaSnCJd8Hgi1uKQH0DpJ5XuS8umezVNtLF-41alUU1Zqrw55ycJAKtV9ENrVW3oHNvOqn7Ytz5vjHVq1l3gE0NgKE1lf0K4oIVoqnDdS9vImGrbSo8N1EOmpIXY_oM0pobKEWZciHwYbxTMwjFQU2nx-VbSsNySyPIITWH3R1GoeqeP-RFahvU3zsvRDNnC1ivntyTF8BUik3MrdY7JwHCLhKQDnC8Rj3KWdOs9lSo6eXMbaLQBfGVuJ5GXL_od_ZHFjPSi3CQ"
//https://curlconverter.com/node-request/

//https://github.com/thelinmichael/spotify-web-api-node
//https://curlconverter.com/node-request/
//https://developer.spotify.com/console/get-playlist-tracks/?limit=100
//https://developer.spotify.com/dashboard/applications/0bc0482177aa463cb155fc5552702e5c


//My wrapped playlist ids
//2019 wrapped -> 37i9dQZF1EteouiNQdvBtB
//2020 wrapped -> 37i9dQZF1EM9pfEtx72HUq
//2021 wrapped -> 37i9dQZF1EUMDoJuT8yJsl
//2022 wrapped -> 37i9dQZF1F0sijgNaJdgit
